...
const Signup = () => {
  return (
    <div className="mt-20 sm:mt-10 min-h-screen flex items-center justify-center w-full py-5 ">
      <div className="bg-white shadow-md rounded-3xl px-10 py-6 w-full sm:w-[27vw] mt-40">
        ...
        <form>
          ...
          <div className="flex items-center justify-end mb-4">
            <Link className="text-xs text-black " to="/login">Already have a account? Log In</Link>
          </div>
